...
<body class="page-header-fixed">
   ...
   $(function() {   
       ...
       $(".table-toolbar").toolbarLite({
           items: [ 
               { splitter: true }, 
			   { link: true, display: "审核", css: "glyphicon glyphicon-camera", showIcon: true, url: "javascript:;", 
                   ...
                   if(!(auditstate == "审核中" || auditstate == "审核中")){
                   	alert("非审核中状态不能审核");
                   	return false;
                   }
                   ...
                   if (!confirm("确认提交所选数据吗?")){
               		...
               		location.href = "<%=UrlUtil.resolveWithReturnUrl("/wipecost/auditwipecost/{0}", requestUrl, requestQuery, pageContext)%>".replace("{0}",pkuid);
               		 return false;
               	 }
			   } 
