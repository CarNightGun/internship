                     ...
                     <form:form modelAttribute="contentModel" class="form-horizontal" method="POST">
                        ...
                        <form:hidden path="pkuid"/>
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-10">
                                 <form:textarea path="wipeRemark" required="required"  class="form-control" placeholder="凭证说明"/><br/>
                              </div>
                           </div> 
                           <div class="form-group">
						                     ...
						                     <table class="table table-striped table-bordered table-hover" id="data-table">
						                        ...
						                        <td> 
											        ...
											        <tr class="odd gradeX">
													    ...
													    </td><form:hidden path="wipeCostDetails[${vs.index}].pkuid"/>
											            <td><form:input path="wipeCostDetails[${vs.index}].costClass.categoryName" readonly="true" disabled="true" style="border:none" /></td>
											            <td><form:input path="wipeCostDetails[${vs.index}].accounting.categoryCode" readonly="true" disabled="true" style="border:none"/></td>
											            <td><form:input path="wipeCostDetails[${vs.index}].accounting.categoryName" readonly="true" disabled="true" style="border:none"/></td>   
											            <td><form:input path="wipeCostDetails[${vs.index}].wipeCost.wipeCode" readonly="true" disabled="true" style="border:none"/></td>
											            <td><form:input path="wipeCostDetails[${vs.index}].wipeCost.wipeCostName" readonly="true" disabled="true" style="border:none"/></td>
											            <td><form:input path="wipeCostDetails[${vs.index}].wipedDocNumber" readonly="true" disabled="true" style="border:none"/></td>
											            <td><form:input path="wipeCostDetails[${vs.index}].amount" readonly="true" disabled="true" style="border:none"/></td>
											        </tr>
											        </c:forEach>
						                        </tbody>
						                     </table>
