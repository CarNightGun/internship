...
<body class="page-header-fixed">
            ...
            <div class="col-md-12">
				<div class="portlet box light-grey">
				   <div class="portlet-title">
					  <div class="caption"><i class="icon-search"></i>专业计划称检索</div>
				   </div>
							...
							<div class="row">
							   ...
							   <div class="col-md-6">
								  <div class="form-group">
									 ...
									 <div class="col-md-9">
										<form:select path="costCategory.pkuid" class="form-control">  
							                <option value="">请选择</option>  
                  ...
                  <div class="portlet-body">
                     ...
                     <div class="dataTables_wrapper form-inline" role="grid">
		                     ...
		                     <table class="table table-striped table-bordered table-hover" id="data-table">
		                        ...
		                        <tbody>
							        ...
							        <tr class="odd gradeX">
							            ...
							            <td>${ item.costCategory.categoryCode }</td>
							            <td>${ item.costCategory.categoryName }</td>
							            <td>${ item.price }</td>  
	                     ...
	                     <c:import url = "../common/paging.jsp">
	        				...
	        				<c:param name="urlAddress" value="/costlistdetail/list"/>
	       				 </c:import>
       				 </div>
                  </div>
               </div>
   ...
   $(function() {   
       ...
       $(".table-toolbar").toolbarLite({
           items: [
               { link: true, display: "新建", css: "icon-plus", showIcon: true, url: "<%=UrlUtil.resolveWithReturnUrl("/costlistdetail/add", requestUrl, requestQuery, pageContext)%>" },
               { splitter: true }, 
               { link: true, display: "编辑", css: "icon-edit", showIcon: true, url: "<%=UrlUtil.resolveWithReturnUrl("/costlistdetail/edit/{0}", requestUrl, requestQuery, pageContext)%>", 
              	selector: "#data-table .checkboxes", mustSelect: "请先选择数据！", singleSelect: "该操作只支持单选！"},
              	{ splitter: true }, 
                { link: true, display: "删除", css: "icon-trash", showIcon: true, url: "<%=UrlUtil.resolveWithReturnUrl("/costlistdetail/delete/{0}", requestUrl, requestQuery, pageContext)%>", 
