...
<body class="page-header-fixed">
                     ...
                     <div class="dataTables_wrapper form-inline" role="grid">
	                     <div class="table-scrollable">
		                     <table class="table table-striped table-bordered table-hover" id="data-table">
		                        ...
		                        <tbody>
		                        	<c:forEach items="${unitStudentContentModel.items}" var="item">
							        <tr class="odd gradeX">
							        	<td class="check_cell">
	                     ...
	                     <c:import url = "../common/paging.jsp">
	        				<c:param name="pageModelName" value="unitStudentContentModel"/>
   ...
   $(function() {   
       ...
       $(".table-toolbar").toolbarLite({
           items: [
               { link: true, display: "选定学生", css: "icon-plus", showIcon: true, url: "<%=UrlUtil.resolveWithReturnUrl("/unit/selectstudent/{0}/{editId0}", requestUrl, requestQuery, pageContext)%>".replace("{editId0}",${contentModel.pkuid}), 
                 	 selector: "#data-table .checkboxes", mustSelect: "请先选择数据！",confirm: "确认所选学生吗？"}
           ]
       });
    });
   </script>
