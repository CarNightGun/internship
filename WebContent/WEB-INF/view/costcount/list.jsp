            ...
            <div class="col-md-12">
				...
				<div class="portlet box light-grey">
				   <div class="portlet-title">
					  <div class="caption"><i class="icon-search"></i>统计选项</div>
				   </div>
					  ...
					  <form:form modelAttribute="searchModel" class="form-horizontal" method="GET">
						 <div class="form-body">
							<div class="row">						
							   ...
							   <div class="col-md-3">
								  <div class="form-group">
									 <label class="control-label col-md-3">统计年份</label>
									 <div class="col-md-9">
										<form:input path="countYear" type="number" value = "2015" min="2015" step="1" class="form-control placeholder-no-fix" autocomplete="off" placeholder="统计年份"/>
									 </div>
								  </div>
							   </div>							   							   
							</div>
                   ...
                   <!--   <div class="table-toolbar"></div> -->
                     <div class="dataTables_wrapper form-inline" role="grid">
	                     ...
	                     <c:import url = "../common/paging.jsp">
	        				...
	        				<c:param name="urlAddress" value="/costcount/list"/>
	       				 </c:import>
       				 </div>
                  </div>
               </div>
