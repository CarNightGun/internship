...
/**
 * @author tcn 空幕 email:1623092203@qq.com time:2016年5月19日下午11:00:45
 */
public class UrlUtil
{
	...
	public static String resolveWithReturnUrl(String url, Object returnUrl, PageContext pageContext)
	...
	public static String resolveWithReturnUrl(String url, Object returnUrl, Object returnQuery,
			PageContext pageContext) throws JspException, UnsupportedEncodingException
	{
		StringBuilder urlBuilder = new StringBuilder(UrlSupport.resolveUrl(url, null, pageContext));
	...
	public static String resolveWithReturnUrl(String url, Object returnUrl, Object returnQuery,
			String appendReturnQuery, PageContext pageContext) throws JspException,
